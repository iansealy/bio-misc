...
# PODNAME: get_ensembl_gene_biotype.pl
# ABSTRACT: Get the biotype of each Ensembl gene
...
get_ensembl_gene_biotype.pl

Get the biotype of each Ensembl gene
...
This script dumps a list of Ensembl gene stable IDs along with their biotype.
